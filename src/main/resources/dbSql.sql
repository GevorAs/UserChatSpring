...
insert  into `message`(`id`,`text`,`from_id`,`to_id`,`status`,`send_picture`,`send_file`) values (1,'nmjbm',6,1,'NEW',NULL,NULL);
...
insert  into `post`(`id`,`user_id`,`text`,`file_upload_post`,`pic_url_post`,`status`) values (1,1,'vghfgh',NULL,NULL,'ACTIVE'),(2,6,'222222222222222222',NULL,NULL,'ACTIVE');
...
insert  into `request`(`id`,`to_id`,`from_id`) values (1,1,6);
...
insert  into `user`(`id`,`name`,`surname`,`email`,`password`,`picture`,`status_online`,`create_time`,`type`,`status_active`) values (1,'a',NULL,'11@11.11','111111',NULL,'OFFLINE','2018-02-15 19:07:10','USER','ACTIVE'),(6,'rftgyh','fghf','gevor8919@gmail.com','admin','1518826767233_dsf.JPG','ONLINE','2018-02-17 04:19:27','USER','ACTIVE'),(7,'dfgdg','dfgdg','gevor89dfgdfg19@gmail.com','admAin1ghj','1518864580873_dsf.JPG','ONLINE','2018-02-17 14:49:41','USER','ACTIVE');
